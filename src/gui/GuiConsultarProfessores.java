...
public class GuiConsultarProfessores extends JPanel{
    ...
    public GuiConsultarProfessores(){
    ...
    public void inicializarComponentes(){
        ...
        lbTitulo = new JLabel("CONSULTAR PROFESSOR", JLabel.CENTER);
        lbMatricula = new JLabel("Matricula do professor");
